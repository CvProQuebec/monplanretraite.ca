  ...
  if (!post) {
    return (
      <div className="max-w-4xl mx-auto p-8">
        ...
        <button
          className="px-4 py-2 rounded bg-mpr-interactive text-white"
      ...
      <div className="container mx-auto px-6 py-8">
        <article className="max-w-4xl mx-auto bg-white rounded-2xl border border-gray-200 shadow-sm p-6 md:p-10">
          ...
          <header className="mb-6">
            <div className="text-xs text-mpr-navy font-semibold mb-2">{post.category}</div>
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600">
              ...
              <button
                type="button"
                className="ml-auto px-3 py-1 rounded border border-mpr-border text-mpr-navy hover:bg-mpr-interactive-lt disabled:opacity-50"
                onClick={() => {
          ...
          {post.keyPoints && post.keyPoints.length > 0 && (
            <aside className="mb-6 bg-mpr-interactive-lt border border-mpr-border rounded-lg p-4">
              <h2 className="text-lg font-semibold text-mpr-navy mb-2">
                {lang === 'fr' ? 'Points clés' : 'Key Points'}
              </h2>
              <ul className="list-disc list-inside text-mpr-navy space-y-1">
          ...
          <nav className="mt-10 pt-6 border-t border-gray-200 flex items-center justify-between gap-3">
            <div>
              {prev && (
                <button
                  type="button"
                  className="text-left text-mpr-navy hover:underline"
            ...
            <div className="ml-auto">
              {next && (
                <button
                  type="button"
                  className="text-right text-mpr-navy hover:underline"
