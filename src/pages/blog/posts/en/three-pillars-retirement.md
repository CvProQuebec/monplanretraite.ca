...
**Planning your retirement is like building a solid house. You need three strong pillars to support your financial comfort. Here's how these three pillars work together to ensure you have a peaceful retirement — with the exact 2026 figures.**
...
**How much you receive (2026):**
- Maximum: approximately **$727/month** (ages 65 to 74)
- Maximum: approximately **$800/month** (age 75 and over — automatic +10% bonus)
- The amount depends on the number of years you've lived in Canada

**Important to know:**
- This pension is taxable
- If your net income exceeds **$95,323** per year, you'll have to repay part of it (15¢ per dollar above the threshold)
- You can delay this pension up to age 70 for more money (+36% for life if you wait 5 years)

> ⚠️ **2026 Update:** The clawback threshold is now **$95,323**. Some sources still show $90,997 or $86,912 — those figures are no longer current.

### Guaranteed Income Supplement (GIS)

**For whom:** People who receive OAS and have low income.

**How much (2026):** Up to approximately **$1,100/month** for a single person.

**Advantage:** This benefit is not taxable — it's net money in your pocket.

**Eligibility threshold:** Annual income (excluding OAS) below approximately **$22,800** for a single person.
...
- QPP: approximately **$1,433/month** (at 65, with maximum contributions)
- CPP: approximately **$1,395/month** (at 65, with maximum contributions)
...
- **After 65:** Your pension increases by **0.7% per month** (QPP up to 72; CPP up to 70)

**Practical example:**
- If you take your pension at 60: approximately 36% less than at 65
- If you wait until 70: **+42%** compared to age 65

**How to know your rights:**
- Request your statement on the Retraite Québec website (QPP) or My Service Canada Account (CPP)
- Check for errors
...
- **Who pays:** Your employer manages everything
...
If you change jobs, your retirement money can be transferred to a locked-in account (LIRA or locked-in RRSP). This money is "locked" until retirement to ensure you use it for its intended purpose.
...
**2026 RRSP contribution limit:** $33,810 (or 18% of prior year earned income, whichever is less)
...
> 💡 **Key strategy:** Don't wait until 71 to start withdrawing from your RRSP. By making gradual withdrawals between ages 60 and 70 (when your income is low), you reduce your RRIF size at 72 — protecting your OAS pension from the clawback.

### TFSAs (Tax-Free Savings Account)

**The advantages:**
- You never pay taxes on gains
- You can withdraw your money anytime — with no tax impact
- No mandatory minimum withdrawals

**2026 cumulative TFSA contribution room:** up to **$109,000** (if you've never contributed since 2009)

**Why TFSAs are perfect in retirement:** Withdrawals don't count as income. They don't trigger OAS clawback and don't affect GIS eligibility.
...
### A Concrete Example — 2026

**Mr. Tremblay, 65, salary of $50,000 per year:**

**First pillar (governments):**
- Old Age Security: approximately **$727/month**
- QPP: about $800/month
- **Total:** $1,527/month (about **$18,324/year**)

**Second pillar (employer):**
- Employer retirement plan: $600/month
- **Total:** $7,200/year
...
**Total retirement income:** approximately **$35,124/year** (70% of his former salary)

**Tax note:** At this income level, Mr. Tremblay is well below the OAS clawback threshold ($95,323). If he has TFSA savings, he can withdraw from them with no tax impact and no effect on his benefits.
...
These sources are like a regular salary. They don't change according to financial markets.
...
- Contribute to your TFSA if possible

**In your forties:**
- Increase your RRSP contributions
- Check your QPP/CPP rights each year
...
- Start thinking about gradually converting RRSP to TFSA
...
File form T1032 — up to 50% of eligible pension income can be attributed to your spouse.

### Tax Planning and the RRSP Meltdown

**Before retirement:**
- Balance RRSP and TFSA according to your situation
- Between ages 60 and 70, gradually withdraw from your RRSP to reduce future mandatory withdrawals
- Consider your spouse's age for RRIFs

**In retirement:**
- Manage your withdrawals to stay below the OAS clawback threshold ($95,323)
- Use your TFSA for RRIF surpluses
...
- Should I start melting down my RRSP now?
...
- QPP max: ~$1,433/month | CPP max: ~$1,395/month
- GIS max (single): ~$1,100/month (tax-free)
...
*Updated March 1, 2026. Amounts and thresholds are approximate 2026 references, adjusted quarterly. Consult Service Canada or a Certified Financial Planner for your personal situation.*
