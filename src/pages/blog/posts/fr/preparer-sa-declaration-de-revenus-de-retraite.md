...
- Montant 2026 : environ **727 $/mois** (65 à 74 ans)
- Montant 2026 : environ **800 $/mois** (75 ans et plus — bonus automatique de 10 %)
- **Important :** Cette pension est imposable

**Régime de rentes du Québec (RRQ) :**
- Basé sur vos années de cotisation au travail
- Montant maximum 2026 : environ **1 433 $/mois** (à 65 ans, cotisation maximale)
...
- **Important :** Imposable comme le RRQ
...
**Pourquoi c'est important :** Ces revenus vous donnent droit au crédit pour revenu de pension (jusqu'à 2 000 $ protégés).
...
> 💡 **Astuce :** Même avant 65 ans, vous pouvez convertir une petite portion de votre REER en FERR pour accéder au crédit pour revenu de pension. Consultez un planificateur financier.
...
**Comment ça marche :** Vous pouvez donner jusqu'à **50 %** de certains revenus de pension à votre conjoint sur papier (formulaire T1032).
...
### Utilisez votre CELI plutôt que votre FERR

Si vous avez le choix entre retirer du FERR ou du CELI pour couvrir une dépense :
- Le retrait de FERR augmente vos revenus imposables et risque de déclencher la récupération de la SV
- Le retrait du CELI n'a aucun impact fiscal

---

## ⚠️ Récupération de la Sécurité de la vieillesse
...
> ⚠️ **Attention :** Certains guides indiquent encore 90 997 $ ou 86 912 $. Ces chiffres ne sont plus à jour. Le seuil officiel pour 2026 est **95 323 $**.

**Exemple 2026 :**
- Vos revenus : 100 000 $
- Excédent : 4 677 $ (100 000 $ − 95 323 $)
- Remboursement : **701 $** (15 % de 4 677 $)

**À revenu plus élevé :**
- Revenus de 110 000 $
- Excédent : 14 677 $
- Remboursement : **2 202 $/an** — soit presque toute la SV!
...
**Utilisez votre CELI :** Les retraits ne comptent pas comme des revenus.

**Dégel REER entre 60 et 70 ans :** Si vous pouvez retirer graduellement de votre REER avant 70 ans à un taux faible, votre FERR sera plus petit à 72 ans, et la récupération sera plus facile à éviter.
...
- Tous vos feuillets (T4A(OAS), T4A(P), T4RIF, T4A)
...
- Risque de récupération de la SV

**N'hésitez pas à :**
- Utiliser un logiciel d'impôt reconnu (certains sont gratuits pour les aînés)
...
**30 avril :** Date limite pour produire votre déclaration et payer tout solde dû.
...
- Maintenir vos prestations gouvernementales (dont le SRG, renouvelé automatiquement chaque juillet si vous produisez votre déclaration)
...
✅ Vos revenus de retraite sont généralement imposables (sauf le CELI)
✅ Vous avez droit à de nouveaux crédits d'impôt après 65 ans
✅ Le fractionnement peut vous faire économiser beaucoup d'impôt
✅ Seuil de récupération de la SV 2026 : **95 323 $** (pas 90 997 $!)
✅ Organisez-vous bien avec tous vos feuillets
✅ Produisez votre déclaration chaque année pour maintenir vos prestations gouvernementales
...
*Mis à jour le 1er mars 2026. Les montants sont des références approximatives pour 2026, indexées périodiquement. Consultez toujours un professionnel pour vos décisions fiscales personnelles.*
