...
excerpt: Planifier sa retraite, c'est comme construire une maison solide. Vous avez besoin de trois piliers forts pour soutenir votre confort financier. Voici comment la RRQ ou le RPC, les régimes d'employeur et votre épargne personnelle travaillent ensemble pour vous assurer une retraite sereine.
...
# Les trois piliers de votre retraite â€” RRQ/RPC, régimes d'employeur et épargne personnelle expliqués simplement

*Mis à jour le 1er mars 2026 | Temps de lecture : 9 minutes*

**Planifier sa retraite, c'est comme construire une maison solide. Vous avez besoin de trois piliers forts pour soutenir votre confort financier. Voici comment ces trois piliers travaillent ensemble pour vous assurer une retraite sereine â€” avec les chiffres 2026.**

---

## Pourquoi trois piliers?

Quand vous travaillez, votre salaire vient d'une seule source : votre employeur. Ã€ la retraite, c'est différent. Votre argent doit venir de plusieurs endroits pour remplacer votre salaire.
...
**Combien vous recevez (2026) :**
- Maximum : environ **727 $/mois** (de 65 à 74 ans)
- Maximum : environ **800 $/mois** (75 ans et plus â€” +10 % automatique)
- Le montant dépend du nombre d'années que vous avez vécu au Canada

**Important à savoir :**
- Cette pension est imposable
- Si vos revenus nets dépassent **95 323 $** par année, vous devrez en rembourser une partie (taux de récupération : 15 ¢ par dollar au-dessus du seuil)
- Vous pouvez reporter cette pension jusqu'à 70 ans pour avoir plus (+36 % à vie si vous attendez 5 ans)

> âš ï¸ **Mise à jour 2026 :** Le seuil de récupération est maintenant **95 323 $**. Certaines sources indiquent encore 90 997 $ ou 86 912 $ â€” ces chiffres sont dépassés.

### Le Supplément de revenu garanti (SRG)

**Pour qui** : Les personnes qui reçoivent la SV et qui ont peu de revenus.

**Combien :** Jusqu'à environ **1 100 $/mois** pour une personne seule (2026).

**Avantage** : Cette prestation n'est pas imposable. C'est de l'argent net.

**Seuil d'admissibilité :** Revenu annuel (hors SV) inférieur à environ **22 800 $** pour une personne seule.
...
- RRQ : environ **1 433 $/mois** (à 65 ans, cotisation maximale)
- RPC : environ **1 395 $/mois** (à 65 ans, cotisation maximale)

**Les règles importantes :**
- Vous pouvez commencer à recevoir votre rente à 60 ans, mais elle sera réduite
- Ã€ 65 ans, vous recevez 100 % de votre rente
- Si vous attendez après 65 ans, votre rente augmente

**Les calculs simples :**
- **Avant 65 ans :** Votre rente diminue de 0,5 % à 0,6 % par mois
- **Après 65 ans :** Votre rente augmente de **0,7 % par mois** (RRQ, jusqu'à 72 ans; RPC jusqu'à 70 ans)

**Exemple pratique :**
- Si vous prenez votre rente à 60 ans : environ 36 % de moins qu'à 65 ans
- Si vous attendez jusqu'à 70 ans : **+42 %** par rapport à 65 ans

**Comment connaître vos droits :**
- Demandez votre relevé sur le site de Retraite Québec (retraitequebec.gouv.qc.ca)
...
- Ã€ quel âge pouvez-vous prendre votre retraite?
- Que se passe-t-il si vous changez d'emploi?

### Les comptes immobilisés

Si vous changez d'emploi, votre argent de retraite peut être transféré dans un compte immobilisé (CRI ou REER immobilisé). Cet argent est « bloqué » jusqu'à votre retraite pour s'assurer que vous l'utilisiez pour votre retraite.
...
**Limite de cotisation REER 2026 :** 33 810 $ (ou 18 % de votre revenu gagné de l'année précédente, selon le moindre)

**La transformation en FERR :**
- Ã€ 71 ans, vous devez transformer votre REER en FERR
- Le FERR vous donne un revenu régulier à la retraite
- Vous devez retirer un montant minimum chaque année

> ðŸ’¡ **Stratégie clé :** Ne pas attendre à 71 ans pour commencer à retirer du REER. En faisant des retraits graduels entre 60 et 70 ans (quand vos revenus sont bas), vous réduisez la taille de votre FERR à 72 ans â€” et vous protégez votre pension de la SV contre la récupération.

### Les CELI (Compte d'épargne libre d'impôt)

**Les avantages :**
- Vous ne payez jamais d'impôts sur les gains
- Vous pouvez retirer votre argent n'importe quand â€” sans impact fiscal
- Aucun retrait minimum obligatoire

**Droits de cotisation cumulatifs CELI 2026 :** jusqu'à **109 000 $** (si vous n'avez jamais cotisé depuis 2009)

**Pourquoi le CELI est parfait à la retraite :** Les retraits ne comptent pas comme des revenus. Ils ne déclenchent pas la récupération de la SV et n'affectent pas votre SRG.
...
### Un exemple concret â€” 2026

**Monsieur Tremblay, 65 ans, salaire de 50 000 $ par année :**

**Premier pilier (gouvernements) :**
- Sécurité de la vieillesse : environ **727 $/mois**
- RRQ : environ **800 $/mois**
- **Total :** 1 527 $/mois (environ **18 324 $/an**)

**Deuxième pilier (employeur) :**
- Régime de retraite d'employeur : 600 $/mois
- **Total :** 7 200 $/an
...
**Revenu total de retraite :** environ **35 124 $/an** (70 % de son ancien salaire)

**Remarque fiscale :** Ã€ ce niveau de revenus, Monsieur Tremblay est bien en dessous du seuil de récupération de la SV (95 323 $). S'il a des économies dans son CELI, il peut y puiser sans aucun impact sur ses prestations.
...
- Commencez à penser au dégel REER vers CELI
...
Ã€ la retraite, vous pouvez partager certains revenus avec votre conjoint pour payer moins d'impôts. Cela fonctionne avec :
- Les revenus de FERR
- Les rentes de régimes d'employeur
- Certaines autres sources de revenus de retraite

Formulaire T1032 â€” jusqu'à 50 % des revenus de pension peuvent être attribués au conjoint.

### La planification fiscale et le dégel REER

**Avant la retraite :**
- Ã‰quilibrez REER et CELI selon votre situation
- Entre 60 et 70 ans, retirez graduellement du REER pour réduire les retraits obligatoires futurs
- Considérez l'âge de votre conjoint pour les FERR

**Ã€ la retraite :**
- Gérez vos retraits pour rester sous le seuil de récupération de la SV (95 323 $)
...
- Devrais-je commencer à dégeler mon REER maintenant?
...
1. **Gouvernements (RRQ/RPC + SV)** : La base solide, environ 30â€“40 % de vos besoins
2. **Employeur** : Le complément important, si disponible
3. **Ã‰pargne personnelle** : Souvent le plus gros pilier pour une retraite confortable

**Chiffres clés 2026 :**
- SV : ~727 $/mois (65â€“74 ans) | ~800 $/mois (75+)
- RRQ max : ~1 433 $/mois | RPC max : ~1 395 $/mois
- SRG max (célibataire) : ~1 100 $/mois (non imposable)
- Seuil de récupération SV : **95 323 $**
- CELI cumulatif : 109 000 $
...
*Mis à jour le 1er mars 2026. Les montants et seuils sont des références approximatives pour 2026, indexées trimestriellement. Consultez Service Canada ou un planificateur financier certifié pour votre situation personnelle.*
