  ...
  return (
    <div className="emergency-planning-container">
      ...
      <div style={{
        ...
        <p><strong>Important:</strong> Ce document contient des informations sensibles.</p>
        <p>Conservez-le dans un endroit sûr et informez une personne de confiance de son existence.</p>
        <p>Dernière mise à jour: {data.dateMAJ} | Version: {data.versionDocument}</p>
      </div>
    </div>
  );
};
