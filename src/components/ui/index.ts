// ===== INDEX DES COMPOSANTS UI DE BASE DE BASE DE BASE DE BASE DE BASE DE BASE =====
// Export centralisé de tous les composants UI de base de base de base de base de base de base
...
// Composants de dialogue et modales
...
// Composants de mise en page avancés
...
// Composants d'aspect ratio
export { AspectRatio } from './aspect-ratio';

// Composants d'avatar
export { Avatar, AvatarFallback, AvatarImage } from './avatar';

// Composants de menubar
...
// Composants de carte en verre
export { GlassCard } from './GlassCard';

// Composants de modal d'amélioration
export { UpgradeModal } from './upgrade-modal';
export { AdvancedUpgradeModal } from './advanced-upgrade-modal';
