    ...
    <div className={`space-y-3 ${className}`}>
      ...
      <div className="flex gap-2">
        <Input
          ...
          maxLength={4}
          className="w-20 text-center text-lg p-4 h-14 border-2 border-charcoal-200 focus:border-charcoal-600"
        />
        ...
        <Input
          ...
          maxLength={2}
          className="w-16 text-center text-lg p-4 h-14 border-2 border-charcoal-200 focus:border-charcoal-600"
        />
        <span className="flex items-center text-charcoal-400 text-lg">-</span>
        <Input
          ref={dayRef}
