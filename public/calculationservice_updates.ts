// ===== MISES À JOUR CALCULATIONSERVICE - CORRECTIONS CRITIQUES =====
...
export class CalculationService {
  ...
  static calculateAll(userData: UserData): Calculations {
    try {
      const enhancedCalculations = {
        ...
        rrqOptimization: this.calculateRRQOptimizationEnhanced(userData), // AMÉLIORÉ
  ...
  private static calculateStrategyValue(person1: any, person2: any, strategy: any): number {
    ...
    return person1.valeurActualiseeMaintenant + person2.valeurActualiseeMaintenant;
  }
